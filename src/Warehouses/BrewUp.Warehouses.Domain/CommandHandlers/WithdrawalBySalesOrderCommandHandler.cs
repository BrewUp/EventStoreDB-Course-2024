...
public sealed class WithdrawalBySalesOrderCommandHandler(IRepository repository, ILoggerFactory loggerFactory)
    : CommandHandlerBaseAsync<WithdrawalBySalesOrder>(repository, loggerFactory)
{
